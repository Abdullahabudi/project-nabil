<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 mb-0" style="font-family: 'Playfair Display', serif; color: #2c3e50;">Tambah Booking Baru</h2>
    </x-slot>
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('bookings.store') }}" method="POST">
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-villa">Simpan Booking</button>
                                </div>
                            </form>
                        </div>
                    </div>
